...
const OrderSummary = () => {
  ...
  return (
    ...
    >
      <p className='text-xl font-semibold text-indigo-500'>Order summary</p>
      ...
      <div className='space-y-4'>
        ...
        <div className='flex items-center justify-center gap-2'>
          ...
          <Link
            to='/'
            className='inline-flex items-center gap-2 text-sm font-medium text-indigo-500 underline hover:text-indigo-300 hover:no-underline'
          >
            Continue Shopping
            <MoveRight size={16} />
          </Link>
